...
public class Frame {
    ...
    public static void main(String[] args) {
        Myframe myframe=new Myframe("布局");
        myframe.Enter();
...
class Myframe extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand().equals("Enter")) {
            ...
            JOptionPane.showConfirmDialog(Myframe.this,text1.getText()+text2.getText()+text3.getText()+text4.getText(),"警告",JOptionPane.YES_NO_OPTION);
        }
    }
